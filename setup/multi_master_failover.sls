...
{# for master: sudo salt-ssh '*M*' state.sls m2m-failover pillar="{'role': 'master'}" #}                                                                                                                                                        
{# for minion: sudo salt-ssh '*min*' state.sls m2m-failover pillar="{'m1': '1.1.1.1', 'm2':'2.2.2.2', 'role': 'minion'}" #}
